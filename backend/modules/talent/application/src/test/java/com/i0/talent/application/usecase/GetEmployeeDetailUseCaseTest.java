...
class GetEmployeeDetailUseCaseTest {
    ...
    void should_GetEmployeeDetail_When_ValidRequestWithAuth() {
        ...
        Employee employee = Employee.reconstruct(
                ...
                "张三",
                "EMP001",
                com.i0.talent.domain.valueobjects.WorkLocation.of("beijing", "北京", "CITY"),
    ...
    void should_GetEmployeeDetail_When_ValidRequestWithoutAuth() {
        ...
        Employee employee = Employee.reconstruct(
                ...
                "李四",
                "EMP002",
                com.i0.talent.domain.valueobjects.WorkLocation.of("shanghai", "上海", "CITY"),
                com.i0.talent.domain.valueobjects.Nationality.ofCountry("china", "中国"),
                "lisi@example.com",
                "市场部",
                "市场专员",
    ...
    void should_ThrowException_When_NoAccessPermission() {
        ...
        Employee employee = Employee.reconstruct(
                ...
                "王五",
                "EMP003",
                com.i0.talent.domain.valueobjects.WorkLocation.of("shenzhen", "深圳", "CITY"),
                com.i0.talent.domain.valueobjects.Nationality.ofCountry("china", "中国"),
                "wangwu@example.com",
                "技术部",
                "软件工程师",
    ...
    void should_CalculateWorkYearsCorrectly_When_EmployeeIsTerminated() {
        ...
        Employee employee = Employee.reconstruct(
                ...
                "赵六",
                "EMP004",
                com.i0.talent.domain.valueobjects.WorkLocation.of("guangzhou", "广州", "CITY"),
                com.i0.talent.domain.valueobjects.Nationality.ofCountry("china", "中国"),
                "zhaoliu@example.com",
                "财务部",
                "会计",
    ...
    void should_IdentifySensitiveData_When_EmployeeInGermany() {
        ...
        Employee employee = Employee.reconstruct(
                ...
                "钱七",
                "EMP005",
                com.i0.talent.domain.valueobjects.WorkLocation.of("berlin", "柏林", "CITY"),
                com.i0.talent.domain.valueobjects.Nationality.ofCountry("germany", "德国"),
                "qianqi@example.com",
                "研发部",
                "高级工程师",
    ...
    void should_GetAccessPermissionDescription_When_ValidRequest() {
        ...
        Employee employee = Employee.reconstruct(
                ...
                "孙八",
                "EMP006",
                com.i0.talent.domain.valueobjects.WorkLocation.of("hangzhou", "杭州", "CITY"),
                com.i0.talent.domain.valueobjects.Nationality.ofCountry("china", "中国"),
                "sunba@example.com",
                "产品部",
                "产品经理",
    ...
    void should_GetLegalNotice_When_ValidRequest() {
        ...
        Employee employee = Employee.reconstruct(
                ...
                "周九",
                "EMP007",
                com.i0.talent.domain.valueobjects.WorkLocation.of("singapore", "新加坡", "CITY"),
                com.i0.talent.domain.valueobjects.Nationality.ofCountry("singapore", "新加坡"),
                "zhoujiu@example.com",
                "销售部",
                "销售经理",
    ...
    void should_CalculateWorkYearsCorrectly_When_EmployeeHasValidData() {
        ...
        Employee employee = Employee.reconstruct(
                ...
                "吴十",
                "EMP009",
                com.i0.talent.domain.valueobjects.WorkLocation.of("chengdu", "成都", "CITY"),
                com.i0.talent.domain.valueobjects.Nationality.ofCountry("china", "中国"),
                "wushi@example.com",
                "人事部",
                "HR专员",
