...
-- 2. 活跃员工数指标
INSERT INTO indicators (id, name, description, dataset_id, calculation, type, unit, creator, updater) VALUES
('indicator-active-employees', '活跃员工数', '当前状态为活跃的员工数量', 'dataset-employee-basic', 'COUNT(CASE WHEN status = ''ACTIVE'' THEN 1 END)', 'count', '人', 'system', 'system');

-- 3. 本月新入职指标
INSERT INTO indicators (id, name, description, dataset_id, calculation, type, unit, creator, updater) VALUES
('indicator-new-hires-month', '本月新入职', '本月新入职员工数量', 'dataset-employee-basic', 'COUNT(CASE WHEN join_date >= DATE_FORMAT(NOW(), ''%Y-%m-01'') THEN 1 END)', 'count', '人', 'system', 'system');
...
('chart-employee-status-pie', '员工状态分布', '显示员工状态分布的饼图', 'pie', 'indicator-active-employees', 'status', '员工状态分布',
...
('chart-department-size-bar', '部门人数分布', '显示各部门员工数量的柱状图', 'bar', 'indicator-departments-count', 'department', '部门人数分布', '部门', '人数',
'{"color": "#5470c6", "grid": {"left": "3%", "right": "4%", "bottom": "3%", "containLabel": true}}', 'system', 'system');

-- 3. 工作地点分布图
INSERT INTO charts (id, name, description, type, indicator_id, dimension, title, x_axis_label, y_axis_label, config, creator, updater) VALUES
('chart-location-distribution-bar', '工作地点分布', '显示各工作地点员工分布情况', 'bar', 'indicator-avg-dept-size', 'work_location_id', '工作地点分布', '工作地点', '员工数',
'{"color": "#91cc75", "grid": {"left": "3%", "right": "4%", "bottom": "3%", "containLabel": true}}', 'system', 'system');

-- 4. 员工国籍分布饼图
INSERT INTO charts (id, name, description, type, indicator_id, dimension, title, config, creator, updater) VALUES
('chart-nationality-pie', '员工国籍分布', '显示员工国籍分布的饼图', 'pie', 'indicator-avg-dept-size', 'nationality_id', '员工国籍分布',
'{"colors": ["#5470c6", "#91cc75", "#fac858", "#ee6666", "#73c0de", "#3ba272", "#fc8452", "#9a60b4"], "legend": {"position": "bottom"}}', 'system', 'system');

-- 5. 入职趋势折线图
INSERT INTO charts (id, name, description, type, indicator_id, dimension, title, x_axis_label, y_axis_label, config, creator, updater) VALUES
('chart-hiring-trend-line', '入职趋势分析', '显示近12个月入职趋势的折线图', 'line', 'indicator-new-hires-month', 'hire_month', '入职趋势分析', '月份', '入职人数',
...
INSERT INTO report_charts (id, report_id, chart_id, position_x, position_y, width, height) VALUES
('rc-007', 'report-employee-distribution', 'chart-nationality-pie', 0, 10, 18, 4);
